...
<xsl:variable name="fit.finalCount.list" select="//testResults/finalCounts"/>
...
<xsl:variable name="fit.correctcount" select="sum($fit.finalCount.list/right)"/>
<xsl:variable name="fit.failures" select="sum($fit.finalCount.list/wrong)"/>
<xsl:variable name="fit.notrun" select="sum($fit.finalCount.list/ignores)"/>
<xsl:variable name="fit.exceptions" select="sum($fit.finalCount.list/exceptions)"/>
